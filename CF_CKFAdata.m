classdef CF_CKFAdata < muiPropertyUI             
%
%-------class help---------------------------------------------------------
% NAME
%   CF_CKFAdata.m
...
% USAGE
%   obj = CF_CKFAdata.setInput(mobj); %mobj is a handle to Main UI
% SEE ALSO
...
%%  
    methods (Static)  
        function obj = setInput(mobj,editflag)
            ...
            classname = 'CF_CKFAdata';               
            obj = getClassObj(mobj,'Inputs',classname);
            if isempty(obj)
                obj = CF_CKFAdata(mobj);         
            end
